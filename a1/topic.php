...
<body>
    ...
    if (isset($_POST['Countries'])) {
        ...
        if (file_exists($filename)) {
            ...
            ?>
            <form name="AnsForm" action="topic.php" method="post">
                <?php
                    $index = 0; // Initialize a counter for the questions
                    foreach ($_SESSION['questions_answers'] as $question => $correctAnswer) {
    ...
    {
    ?>
        <form name="QuizForm" action="topic.php" method="post">
            &nbsp;<input type="submit" name="Countries" value="Countries" style="margin-right: 30px;"/><input type="submit" name="Music" value="Music" style="margin-right: 30px;"/></p><p><input type="submit" name="Exit" value="Exit"/></p>
        </form>
    <?php
    }
    ?>
